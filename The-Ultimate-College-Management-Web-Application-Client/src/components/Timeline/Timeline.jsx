    ...
    <li>
      <div className="timeline-start timeline-box dark:bg-brand-navyblue border-none bg-brand-blue text-white dark:text-gray-300">
        ...
        <p>
          ...
          culpa, doloremque sed accusantium labore incidunt perferendis eligendi
          magnam! Fugiat, vitae suscipit. Lorem ipsum dolor sit, amet
          consectetur adipisicing elit. Ipsam porro nulla fugit dolore ut quam, </p>
        ...
        <p>
          dignissimos maiores? Sapiente eaque distinctio ducimus, corrupti error
          harum quae eius officiis, magnam deleniti possimus. Lorem ipsum, dolor
          sit amet consectetur adipisicing elit. Neque similique ad maiores
          tenetur, eligendi commodi nisi dicta debitis consequatur voluptatibus
          et reprehenderit tempora eaque aliquid, omnis inventore unde earum
          eius.
        </p>
      </div>
    ...
    <li>
      ...
      <div className="timeline-end timeline-box dark:bg-brand-navyblue border-none bg-brand-blue text-white dark:text-gray-300">
        ...
        <p>
          ...
          corporis iusto deleniti? Eveniet, dolorem. Lorem ipsum dolor sit, amet
          consectetur adipisicing elit. Itaque eum nobis officia impedit </p>
          <ul className="list list-disc ms-12 my-4">
            <li>Physics</li>
            <li>Chemistry</li>
            <li>Higher Mathematics</li>
        ...
        <p>
          ...
          rerum, quae ea debitis. Debitis optio vel quos? Lorem ipsum dolor sit
          amet consectetur adipisicing elit. Excepturi atque similique natus
          aliquid ad debitis exercitationem autem quos corrupti aspernatur
          beatae labore error ea quis, adipisci inventore doloremque dicta
          suscipit.
        </p>
      </div>
      <div className="timeline-middle">
    ...
    <li>
      ...
      <div className="timeline-start timeline-box dark:bg-brand-navyblue border-none bg-brand-blue text-white dark:text-gray-300">
        ...
        <p>
          ...
          perspiciatis iusto illum dignissimos perferendis sit facilis mollitia?
          Sed qui beatae, nobis numquam ipsam reprehenderit dolorem, iste
          consequatur pariatur nulla modi. Lorem ipsum, dolor sit amet
          consectetur adipisicing elit. Qui vero doloribus recusandae quo x</p>
          <ul className="list list-disc ms-12 my-4">
            <li>Physics</li>
            <li>Chemistry</li>
            <li>Higher Mathematics</li>
